...
const dateRangePickerStyles = tv({
  slots: {
    ...
    dateRangePickerInputStart: "px-2 lg:text-sm tabular-nums uppercase text-sm",
    dateRangePickerInputEnd: "flex-1 px-2 py-1.5 tabular-nums uppercase text-sm lg:text-sm",
    dateRangePickerDash:
